...
public class DataController extends SQLiteOpenHelper {
    ...
    public List<RoutePoint> allRoutePoints() {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                RoutePoint point = new RoutePoint(id, name, desc, lan, lat, false);
    ...
    public void onCreate(SQLiteDatabase db) {
        String qryCreateRoutePoint = "CREATE TABLE RoutePoint(Id INT PRIMARY KEY, Noorderbreedte FLOAT, Oosterlengte FLOAT, Naam TEXT, Opmerking TEXT)";
        ...
        String qryCreateBlindWallImages = "CREATE TABLE BlindWallImages{Id INT PRIMARY KEY, ";


        db.beginTransaction();
        db.execSQL(qryCreateRoutePoint);
        String[] inserts = qryInsertRoutePoint.split("\\n");
